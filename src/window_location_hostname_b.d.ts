...
export declare const window_location_hostname_b: import("@ctx-core/object").Be<window_location_hostname_Ctx, "window_location_hostname", window_location_hostname_T>;
