...
export const window_location_pathname_b = _b<window_location_pathname>(
	'window_location_pathname', ctx=>
		derived([
				pathname_b(ctx),
...
export type { $window_location_pathname_type as $pathname__location__window }
export type window_location_pathname = Readable<$window_location_pathname_type>
export type { window_location_pathname as pathname__location__window }
