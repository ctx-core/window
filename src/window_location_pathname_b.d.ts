...
export declare const window_location_pathname_b: import("@ctx-core/object").Be<window_location_pathname_Ctx, "window_location_pathname", window_location_pathname_T>;
